...
public class StringLock {
    ...
    public void lock( String pid ) {
		...
		synchronized(lockMap) {
		    ...
		    if( lockAdm == null ) {
		    	// making it fair should allow testing by sequence,
		    	// but do we want the performance hit?
			    lockAdm = new ReentrantLock(true);
    ...
    public void unlock( String pid ) {
	    ...
	    synchronized(lockMap) {
		    ...
		    System.out.println("queued: " + lockAdm.getQueueLength() + " ; holds: " + lockAdm.getHoldCount());
