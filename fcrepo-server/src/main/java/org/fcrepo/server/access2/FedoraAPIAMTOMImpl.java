...
/**
 * This class was generated by Apache CXF 2.4.0 2011-07-18T15:38:45.033+02:00
...
public class FedoraAPIAMTOMImpl implements FedoraAPIAMTOM {
	 ...
	 * )*
	 */
	public org.fcrepo.server.types2.mtom.gen.MIMETypedStream getDatastreamDissemination(
			java.lang.String pid, java.lang.String dsID,
		...
		try {
			...
			org.fcrepo.server.types2.mtom.gen.MIMETypedStream genMIMETypedStream = TypeUtility
	 ...
	 * ,)String asOfDateTime )*
	 */
	public org.fcrepo.server.types2.mtom.gen.MIMETypedStream getDissemination(
			String pid,
	 ...
	 * ,)String asOfDateTime )*
	 */
	public org.fcrepo.server.types2.mtom.gen.ObjectProfile getObjectProfile(
			String pid, String asOfDateTime) {
		MessageContext ctx = context.getMessageContext();
		Context context = ReadOnlyContext.getSoapContext(ctx);
		assertInitialized();
		try {
			org.fcrepo.server.access.ObjectProfile objectProfile = s_access
					.getObjectProfile(context, pid,
							DateUtility.parseDateOrNull(asOfDateTime));
			org.fcrepo.server.types2.mtom.gen.ObjectProfile genObjectProfile = TypeUtility
	 ...
	 */
	public org.fcrepo.server.types2.mtom.gen.FieldSearchResult findObjects(
			org.fcrepo.server.types2.mtom.gen.ArrayOfString resultFields,
	...
	public org.fcrepo.server.types2.mtom.gen.RepositoryInfo describeRepository() {
		...
		assertInitialized();
		try {
			org.fcrepo.server.access.RepositoryInfo repositoryInfo = s_access
					.describeRepository(context);
			org.fcrepo.server.types2.mtom.gen.RepositoryInfo genRepositoryInfo = TypeUtility
	 ...
	 * asOfDateTime )*
	 */
	public List<org.fcrepo.server.types2.mtom.gen.ObjectMethodsDef> listMethods(
			String pid, String asOfDateTime) {
		MessageContext ctx = context.getMessageContext();
		Context context = ReadOnlyContext.getSoapContext(ctx);
		assertInitialized();
	 ...
	 * sessionToken )*
	 */
	public org.fcrepo.server.types2.mtom.gen.FieldSearchResult resumeFindObjects(
			String sessionToken) {
		MessageContext ctx = context.getMessageContext();
		Context context = ReadOnlyContext.getSoapContext(ctx);
		assertInitialized();
	 ...
	 * ,)String asOfDateTime )*
	 */
	public List<org.fcrepo.server.types2.mtom.gen.DatastreamDef> listDatastreams(
			String pid, String asOfDateTime) {
		MessageContext ctx = context.getMessageContext();
		Context context = ReadOnlyContext.getSoapContext(ctx);
		assertInitialized();
