 ...
 * @author Bill Niebel
 */
public class ContextRegisteringPolicyEnforcementPoint 
extends AbstractPolicyEnforcementPoint
implements PolicyEnforcementPoint {

    private static final Logger logger =
            LoggerFactory.getLogger(ContextRegisteringPolicyEnforcementPoint.class);
    ...
    public ContextRegisteringPolicyEnforcementPoint(PDPConfig pdpConfig, ContextRegistry registry, ModuleConfiguration authzConfiguration)
