...
public class MelcoePDPSOAP11BindingStub
        ...
        implements org.fcrepo.server.security.xacml.pdp.client.MelcoePDPPortType {
    ...
    public MelcoePDPSOAP11BindingStub(javax.xml.rpc.Service service)
        ...
        cls = org.fcrepo.server.security.xacml.pdp.client.Evaluate.class;
        ...
        qName =
                new javax.xml.namespace.QName("http://pdp.xacml.melcoe/xsd",
                                              ">evaluateResponse");
        cachedSerQNames.add(qName);
        cls = org.fcrepo.server.security.xacml.pdp.client.EvaluateResponse.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
        ...
        qName =
                new javax.xml.namespace.QName("http://pdp.xacml.melcoe/xsd",
                                              ">EvaluationException");
        cachedSerQNames.add(qName);
        cls = org.fcrepo.server.security.xacml.pdp.client.EvaluationExceptionType0.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
        ...
        qName =
                new javax.xml.namespace.QName("http://pdp.xacml.melcoe/xsd",
                                              "EvaluationException");
        cachedSerQNames.add(qName);
        cls = org.fcrepo.server.security.xacml.pdp.client.EvaluationException.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
        ...
        qName =
                new javax.xml.namespace.QName("http://pdp.xacml.melcoe/xsd",
                                              "Exception");
        cachedSerQNames.add(qName);
        cls = org.fcrepo.server.security.xacml.pdp.client.Exception.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
        ...
        qName =
                new javax.xml.namespace.QName("http://pdp.xacml.melcoe/xsd",
                                              "MelcoePDPException");
        cachedSerQNames.add(qName);
        cls = org.fcrepo.server.security.xacml.pdp.client.MelcoePDPException.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
    ...
    public java.lang.String evaluateBatch(java.lang.String[] requests)
        ...
        try {
            ...
            if (axisFaultException.detail != null) {
                ...
                if (axisFaultException.detail instanceof org.fcrepo.server.security.xacml.pdp.client.EvaluationExceptionType0) {
                    throw (org.fcrepo.server.security.xacml.pdp.client.EvaluationExceptionType0) axisFaultException.detail;
                }
            }
