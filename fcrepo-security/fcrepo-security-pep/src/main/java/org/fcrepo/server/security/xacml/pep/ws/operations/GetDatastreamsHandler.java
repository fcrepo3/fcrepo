...
public class GetDatastreamsHandler
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(GetDatastreamsHandler.class);

    public GetDatastreamsHandler(ContextHandler contextHandler)
            throws PEPException {
    ...
    public RequestCtx handleRequest(SOAPMessageContext context)
        ...
        try {
            ...
            actions.put(Constants.ACTION.ID.getURI(),
                        Constants.ACTION.GET_DATASTREAMS
                                .getStringAttribute());
            ...
            LogUtil.statLog(getUser(context),
                            Constants.ACTION.GET_DATASTREAMS.uri,
                            pid,
                            null);
        } catch (Exception e) {
