...
public class ModifyDatastreamByValueHandler
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(ModifyDatastreamByValueHandler.class);

    public ModifyDatastreamByValueHandler(ContextHandler contextHandler)
            throws PEPException {
    ...
    public RequestCtx handleRequest(SOAPMessageContext context)
        ...
        try {
            ...
            LogUtil.statLog(getUser(context),
                            Constants.ACTION.MODIFY_DATASTREAM_BY_VALUE.uri,
                            pid,
                            dsID);
        } catch (Exception e) {
