...
public class MelcoePDPLocator
        ...
        implements org.fcrepo.server.security.xacml.pdp.client.MelcoePDP {
    ...
    public org.fcrepo.server.security.xacml.pdp.client.MelcoePDPPortType getMelcoePDPSOAP11port_http(java.net.URL portAddress)
            throws javax.xml.rpc.ServiceException {
        try {
            org.fcrepo.server.security.xacml.pdp.client.MelcoePDPSOAP11BindingStub _stub =
                    new org.fcrepo.server.security.xacml.pdp.client.MelcoePDPSOAP11BindingStub(portAddress,
                                                                            this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface)
            throws javax.xml.rpc.ServiceException {
        try {
            if (org.fcrepo.server.security.xacml.pdp.client.MelcoePDPPortType.class
                    .isAssignableFrom(serviceEndpointInterface)) {
                org.fcrepo.server.security.xacml.pdp.client.MelcoePDPSOAP11BindingStub _stub =
                        new org.fcrepo.server.security.xacml.pdp.client.MelcoePDPSOAP11BindingStub(new java.net.URL(MelcoePDPSOAP11port_http_address),
                                                                                this);
                _stub.setPortName(getMelcoePDPSOAP11port_httpWSDDServiceName());
                return _stub;
            }
