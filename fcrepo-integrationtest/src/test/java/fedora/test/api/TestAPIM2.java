...
public class TestAPIM2
    ...
    public void testIngest() throws Exception {
        ...
        for (String resourceFilename : resourceFilenames) {
            ...
            if (resourceFile.isFile()) {
                String resource =
                        FileUtils.readFileToString(resourceFile, "UTF-8");
                TemplatedResourceIterator tri =
                        new TemplatedResourceIterator(resource,
                                                      "src/test/resources/APIM2/values");
                while (tri.hasNext()) {
        ...
        for (String resourceFilename : resourceFilenames) {
            ...
            if (resourceFile.isFile()) {
                ...
                TemplatedResourceIterator tri =
                        new TemplatedResourceIterator(resource,
                                                      "src/test/resources/APIM2/valuesplain");
                while (tri.hasNext()) {
                    byte[] foxml = tri.next().getBytes("UTF-8");
                    apim.ingest(foxml,
                                FOXML1_1.uri,
    ...
    public void testFieldSearch() throws Exception {
        ...
        TemplatedResourceIterator tri =
                new TemplatedResourceIterator(termsTemplate,
                                              "src/test/resources/APIM2/searchvalues");
        while (tri.hasNext()) {
    ...
    public void testObjectMethods() throws Exception {
        // test object
        String resfile =
                "src/test/resources/APIM2/foxml/demo_SmileyBeerGlass.xml";
